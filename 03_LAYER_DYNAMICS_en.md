...
- `02_ANOMALY_MODEL_en.md` (anomaly score and upgrade anomalies).
...
where $A(\Psi)$ is the anomaly score from `02_ANOMALY_MODEL_en.md`.
...
In `04_TRANSFER_CYCLE_en.md`, we extend this to:
