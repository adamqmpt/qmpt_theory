...
- `qmpt_ide/` — QMPT Lab IDE (Tkinter, dark theme), version 0.7.0 “Ensembles & Anomaly Tracking”.
...
- CLI: headless runner `python -m code.qmpt_runner --config ...`
...
- Config samples: `lab/configs/classical_layer_dynamics.json`, `lab/configs/quantum_layer_stress_probe.json`, `lab/configs/hybrid_layer_cycle.json`, `lab/configs/classical_ensemble.json`
