...
- `02_ANOMALY_MODEL_ru.md` (аномальность, самоосознающая аномалия),
- `03_LAYER_DYNAMICS_ru.md` (стресс, защита),
- `04_TRANSFER_CYCLE_ru.md` (роль в переносе).
